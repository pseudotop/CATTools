...
void h2muAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if (runOnMC_){
    //std::cout<<"<<--mc run start-->>"<<std::endl;
    ...
    if (bosonSample){
      ...
      //std::cout<<"<<--mc run end-->>"<<std::endl;
    }
  }
  //std::cout<<"<--analyze process #1-->"<<std::endl;
  ...
  b_step = 1;
  //std::cout<<"<--analyze process #2-->"<<std::endl;
  ...
  b_step = 2;
  //std::cout<<"<--analyze process #3-->"<<std::endl;
  ...
  b_step = 3;
  //std::cout<<"<--analyze process #4-->"<<std::endl;
  ...
  b_step = 4;
  //std::cout<<"<--analyze process #5-->"<<std::endl;
